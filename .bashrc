...
#[ -s /tmp/a.vim ]\
#	|| wget https://raw.githubusercontent.com/sansna/vimrc/master/vimscripts/a.vim -O /tmp/a.vim --quiet
#[ -s /tmp/auto-pairs.vim ]\
#	|| wget https://raw.githubusercontent.com/sansna/vimrc/master/vimscripts/auto-pairs.vim -O /tmp/auto-pairs.vim --quiet
#[ -s /tmp/boolpat.vim ]\
#	|| wget https://raw.githubusercontent.com/sansna/vimrc/master/vimscripts/boolpat.vim -O /tmp/boolpat.vim --quiet
#[ -s /tmp/pasta.vim ]\
#	|| wget https://raw.githubusercontent.com/sansna/vimrc/master/vimscripts/pasta.vim -O /tmp/pasta.vim --quiet
#[ -s /tmp/taglist.vim ]\
#	|| wget https://raw.githubusercontent.com/vim-scripts/taglist.vim/master/plugin/taglist.vim -O /tmp/taglist.vim --quiet
